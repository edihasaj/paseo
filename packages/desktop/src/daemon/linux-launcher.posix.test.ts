...
async function launch(
  ...
  try {
    ...
    chmodSync(join(app, "Stroll"), 0o755);
    ...
    const executablePath = options.symlink ? join(root, "paseo") : join(app, "Stroll");
    if (options.symlink) symlinkSync(join(app, "Stroll"), executablePath);
