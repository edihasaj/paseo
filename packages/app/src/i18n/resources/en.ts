export const en = {
    ...
    git: {
      actions: {
        ...
        unavailable: {
          ...
          archiveNotWorktree:
            "Archive isn't available here because this workspace was not created as a Stroll worktree",
          mergePrNoForge:
  ...
  desktop: {
    ...
    daemon: {
      ...
      management: {
        ...
        hint: "Let Stroll start and stop the built-in daemon",
        ...
        pausedStopFailed:
          "Built-in daemon management was paused, but Stroll could not stop the daemon.",
        updateFailed: "Unable to update built-in daemon management.",
      },
      keepRunning: {
        title: "Keep daemon running after quit",
        hint: "Daemon keeps running when you quit Stroll",
      },
      logs: {
        title: "Log file",
    ...
    rosetta: {
      ...
      runningIntel: "You're running the Intel build of Stroll under Rosetta on Apple Silicon.",
    ...
    permissions: {
      ...
      testNotification: {
        title: "Stroll notification test",
    ...
    integrations: {
      cli: {
        ...
        installFailed: "Unable to install the Stroll CLI.",
      },
    },
  },
  rootError: {
    title: "Stroll ran into a problem.",
  ...
  pairing: {
    ...
    direct: {
      title: "Direct connection",
      helper: "Enter the address of a Stroll server.",
      fields: {
        host: "Host",
        port: "Port",
        password: "Password",
    ...
    remoteSsh: {
      title: "Remote SSH",
      helper: "Connect to a Stroll daemon running on the remote host.",
      fields: {
        target: "SSH host",
      },
      actions: {
    ...
    device: {
      ...
      relayDocsAccessibility: "Read how Stroll relay works",
      ...
      updateRequired: "Update the host to enable relay from Stroll Desktop.",
      unavailable: "Pairing offer unavailable.",
      hint: "Scan this QR code with Stroll on your phone, or copy the link below.",
      securityWarning:
  ...
  toolCallGroup: {
    ...
    paseoCalls: {
      one: "called Stroll {{count}} time",
      other: "called Stroll {{count}} times",
    },
    and: "and",
  },
  renameModal: {
  ...
  settings: {
    ...
    notifications: {
      ...
      sentDescription: "Stroll handed the notification to the operating system.",
    ...
    metadataGeneration: {
      ...
      description:
        "Choose the model Stroll uses for workspace titles, branch names, commit messages, and pull request drafts",
      selection: "Model selection",
      automatic: "Automatic",
      preferred: "Manual",
      automaticHint: "Stroll picks a fast available model",
      preferredHint: "Choose the model Stroll uses",
      model: "Model",
      fallbackHint: "If it is unavailable, Stroll falls back to another available model",
      docs: "Docs",
    ...
    general: {
      ...
      browserData: {
        ...
        description: "Browser tabs share sign-ins and site data across Stroll.",
    ...
    about: {
      ...
      updates: {
        ...
        installMessage: "This updates Stroll on this computer",
    ...
    host: {
      ...
      skills: {
        ...
        updateTitle: "Update Stroll skills?",
        updateFallback: "Sync bundled skills to this host.",
        uninstallTitle: "Uninstall Stroll skills?",
        uninstallMessage:
          "Removes all Stroll orchestration skills from ~/.agents, ~/.claude, ~/.codex on this host.",
      ...
      daemon: {
        ...
        restart: {
          ...
          offlineMessage:
            "This host is offline. Stroll reconnects automatically-wait until it's back online before restarting.",
          requestFailedTitle: "Error",
          requestFailedMessage:
            "Failed to send the restart request. Stroll reconnects automatically-try again once the host shows as online.",
    ...
    project: {
      ...
      scripts: {
        ...
        serviceHint: "Stroll supervises the process and assigns a port via $PASEO_PORT",
        actions: {
          add: "Add script",
          edit: "Edit",
          remove: "Remove",
      ...
      metadata: {
        title: "Metadata generation",
        info: "Project-specific instructions injected into the AI prompts Stroll uses to generate metadata - use them to enforce your team's conventions like branch naming, commit style, or PR format",
